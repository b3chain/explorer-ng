...
export const wsApiDocsData = [
  ...
  },
  {
    ...
    description: {
      default: 'Subscribe to multiple addresses to receive live updates on new transactions having these addresses in input or output. Limits on the maximum number of tracked addresses apply. For higher tracking limits, consider upgrading to an <a href=\'https://explorer.b3chain.org/enterprise\'>enterprise sponsorship</a>.'
    },
    payload: `{
  "track-addresses": [
  ...
  },
  {
    ...
    description: {
      default: 'Subscribe to multiple transactions to receive live updates on their status and position in the mempool. Limits on the maximum number of tracked addresses apply. For higher tracking limits, consider upgrading to an <a href=\'https://explorer.b3chain.org/enterprise\'>enterprise sponsorship</a>.'
    },
    payload: `{
      "track-txs": [
        "8a4666c6d22ce74fa47e1c4fdb09af556a234cc6a606539a75caf66ba44a2d07",
...
export const faqData = [
  ...
  },
  {
    ...
    title: 'How big is the mempool used by explorer.b3chain.org?',
    options: { officialOnly: true },
  },
  {
    type: 'endpoint',
