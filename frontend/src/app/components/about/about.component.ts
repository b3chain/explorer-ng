...
export class AboutComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.seoService.setDescription($localize`:@@meta.description.about:Learn more about B3Chain Live Explorer Project®\: enterprise sponsors, individual sponsors, integrations, who contributes, FOSS licensing, and more.`);
