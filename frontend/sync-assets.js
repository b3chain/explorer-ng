...
if (config.mempoolCDN) console.log(`${LOG_TAG} MEMPOOL_CDN is set, assets will be downloaded from explorer.b3chain.org`);
    ...
    for (const poolLogo of validFiles) {
      ...
      const downloaded = await processFileItem(poolLogo, {
        ...
        cdnPattern: {
          ...
          to: "explorer.b3chain.org/resources/mining-pools"
        },
    ...
    for (const subtitle of validFiles) {
      ...
      const downloaded = await processFileItem(subtitle, {
        ...
        cdnPattern: {
          ...
          to: "explorer.b3chain.org/resources/promo-video"
        },
  ...
  try {
    ...
    await processFileItem(videoItem, {
      ...
      cdnPattern: {
        ...
        to: "explorer.b3chain.org/resources/promo-video/mempool-promo.mp4"
      },
