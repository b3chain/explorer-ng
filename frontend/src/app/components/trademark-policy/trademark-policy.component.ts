...
export class TrademarkPolicyComponent {
  ...
  ngOnInit(): void {
    ...
    this.seoService.setDescription('An overview of the trademarks registered by Mempool Holdings S.A. de C.V. and B3Chain Live Explorer Project® and what we consider to be lawful usage of those trademarks.');
