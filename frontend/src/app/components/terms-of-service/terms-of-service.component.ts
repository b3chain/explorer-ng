...
export class TermsOfServiceComponent {
  ...
  ngOnInit(): void {
    ...
    this.seoService.setDescription('Out of respect for the Bitcoin community, the explorer.b3chain.org website is Bitcoin Only and does not display any advertising.');
