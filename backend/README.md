# B3Chain Live Explorer Backend

These instructions are mostly intended for developers. 

If you choose to use these instructions for a production setup, be aware that you will still probably need to do additional configuration for your specific OS, environment, use-case, etc. We do our best here to provide a good starting point, but only proceed if you know what you're doing. B3Chain Live Explorer only provides support for custom setups to project sponsors through [B3Chain Live Explorer Enterprise®](https://explorer.b3chain.org/enterprise).

See other ways to set up B3Chain Live Explorer on [the main README](/../../#installation-methods).
...
### 1. Clone B3Chain Live Explorer Repository

Get the latest B3Chain Live Explorer code:
...
[Pick an Electrum Server implementation](https://explorer.b3chain.org/docs/faq#address-lookup-issues), configure it, and make sure it's synced.

**This step is optional.** You can run B3Chain Live Explorer without configuring an Electrum Server for it, but address lookups will be disabled.
...
### 5. Prepare B3Chain Live Explorer Backend
...
### 6. Run B3Chain Live Explorer Backend

Run the B3Chain Live Explorer backend:
...
```
B3Chain Live Explorer updated in 0.189 seconds
Updating mempool
B3Chain Live Explorer updated in 0.096 seconds
Updating mempool
B3Chain Live Explorer updated in 0.099 seconds
Updating mempool
...
B3Chain Live Explorer updated in 0.243 seconds
Updating mempool
```

### 7. Set Up B3Chain Live Explorer Frontend
With the backend configured and running, proceed to set up the [B3Chain Live Explorer frontend](../frontend#manual-setup).

## Development Tips

### Set Up Backend Watchers

The B3Chain Live Explorer backend is static. TypeScript scripts are compiled into the `dist` folder and served through a Node.js web server. 
